...
def get_dataloader(source, split='train', limit=None, tar_path=None, hf_token=None, batch_size=32, num_workers=4, pin_memory=True, image_size=(256, 256)):
    """
    ...
    Args:
        ...
        limit (int): Optional limit on number of samples.
    ...
    if source == 'local_movienet':
        ...
        dataset = TarDataset(tar_path, preprocessor, split=split, limit=limit)
